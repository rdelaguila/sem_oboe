...
- Clustering jerárquico con selección interactiva
- Generación de explicaciones con chain-of-thought
- Evaluación con criterios específicos
- Gráficos mejorados con líneas de corte
"""
...
# Generar gráfico de evolución del silhouette con línea del número elegido
...
if final_clusters != optimal_clusters:
    plt.axvline(x=final_clusters, color='g', linestyle='--', label=f'Seleccionado por usuario: {final_clusters}')
...
print(f"🔧 Número óptimo automático: {optimal_clusters}")
print(f"👤 Número seleccionado: {final_clusters}")
if coherencias:
...
print("  • silhouette_evolution.png - Gráfico de evolución con líneas")
print("  • dendrogram_with_cut.png - Dendrograma con línea de corte")
print("\n✅ Pipeline completo con estrategias QualIT + XAI")
